    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-teal-700 flex items-center justify-center text-white font-black text-lg shadow-lg">
                <ShieldCheck className="w-6 h-6 text-amber-300" />
              </div>
              <div>
                <h3 className="font-extrabold text-white text-base tracking-tight">SIPIL BAUBAU</h3>
                <p className="text-[11px] text-teal-400 font-medium">Pemerintah Kota Baubau</p>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-teal-400">Navigasi Utama</h4>
            <ul className="space-y-2 text-xs">
              <li><Link to="/" className="hover:text-white transition-colors">Beranda</Link></li>
              <li><Link to="/map" className="hover:text-white transition-colors">Peta GIS Pengaduan</Link></li>
              <li><Link to="/submit" className="hover:text-white transition-colors">Buat Laporan Infrastruktur</Link></li>
              <li><Link to="/track" className="hover:text-white transition-colors">Cek Status Laporan</Link></li>
              <li><Link to="/stats" className="hover:text-white transition-colors">Statistik & Analisis OPD</Link></li>
            </ul>
          </div>

          {/* Subdistricts list */}
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-teal-400">Cakupan Wilayah Kecamatan</h4>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-teal-400">Kontak Resmi Pemkot</h4>
            <div className="space-y-2.5 text-xs text-slate-400">
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <a href="https://baubaukota.go.id" target="_blank" rel="noreferrer" className="hover:text-white flex items-center gap-1">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          ...
          <p className="mt-2 sm:mt-0 font-mono text-[11px]">SIPIL BAUBAU v1.0.0 • GovTech Baubau</p>
        </div>
      </div>
    </footer>
  );
