  ...
  return (
    <div className="min-h-screen bg-[#f3f3fe] flex flex-col font-sans">
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-72 bg-white border-r border-[#e1e2ed] p-6 flex flex-col justify-between hidden md:flex shrink-0">
          <div className="space-y-8">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm font-medium text-slate-500">Layanan Pengaduan</p>
            </div>
            ...
            <nav className="space-y-2">
              <Link
                to="/dashboard"
                className="flex items-center space-x-3 px-4 py-3.5 bg-[#dbe1ff] text-[#004ac6] rounded-2xl font-bold text-sm shadow-xs"
              >
                <LayoutDashboard className="w-5 h-5 text-[#004ac6]" />
                <span>Dashboard</span>
              </Link>
              <Link
                to="/submit"
                className="flex items-center space-x-3 px-4 py-3.5 text-slate-600 hover:text-[#004ac6] hover:bg-slate-50 rounded-2xl font-semibold text-sm transition-colors"
              >
          ...
          {/* Bottom User Card */}
          <div className="p-4 bg-[#f3f3fe] rounded-2xl border border-[#e1e2ed] flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="overflow-hidden">
                <p className="text-sm font-bold text-slate-900 truncate">{user?.name || 'Andi Pratama'}</p>
                <p className="text-xs text-slate-500 truncate font-semibold">Warga Terverifikasi</p>
              </div>
            </div>
            <button
              onClick={() => {
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-full sm:w-96">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-white border border-[#e1e2ed] rounded-full text-sm font-medium focus:outline-none focus:border-[#004ac6] shadow-xs"
              />
            </div>

            {/* Bell & Title */}
            <div className="flex items-center space-x-4 self-end sm:self-auto">
              <button className="p-3 bg-white border border-[#e1e2ed] text-slate-600 rounded-full hover:bg-slate-50 transition-colors relative shadow-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white p-6 rounded-3xl border border-[#e1e2ed] shadow-xs space-y-4 relative overflow-hidden">
              <div className="flex items-center justify-between">
                <div className="w-11 h-11 rounded-2xl bg-[#dbe1ff] text-[#004ac6] flex items-center justify-center">
                  <FileText className="w-5 h-5" />
                </div>
                <span className="inline-flex items-center text-xs font-bold text-[#004ac6] bg-[#dbe1ff] px-2.5 py-1 rounded-full">
                  <ArrowUpRight className="w-3.5 h-3.5 mr-0.5" /> +12%
                </span>
              </div>
              <div>
                <p className="text-sm font-semibold text-slate-500">Total Pengaduan</p>
            ...
            <div className="bg-white p-6 rounded-3xl border border-[#e1e2ed] shadow-xs space-y-4 relative overflow-hidden">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center text-xs font-bold text-sky-700 bg-sky-100 px-2.5 py-1 rounded-full">
                  Aktif
                </span>
              </div>
              <div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-[#e1e2ed] shadow-xs space-y-4 relative overflow-hidden">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center text-xs font-bold text-amber-800 bg-amber-100 px-2.5 py-1 rounded-full">
                  Tuntas
                </span>
              </div>
              <div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-[#e1e2ed] shadow-xs space-y-4 relative overflow-hidden">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center text-xs font-bold text-rose-600 bg-rose-100 px-2.5 py-1 rounded-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-white p-6 sm:p-8 rounded-3xl border border-[#e1e2ed] shadow-xs space-y-6">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div>
                  <h3 className="font-extrabold text-lg text-slate-900">Tren Pengaduan</h3>
                  <p className="text-sm text-slate-500">Statistik laporan 6 bulan terakhir</p>
                </div>
                <span className="inline-flex items-center space-x-1 px-3 py-1.5 bg-slate-100 text-slate-700 text-sm font-bold rounded-full">
                  <span>2024</span>
            ...
            <div className="lg:col-span-4 bg-white p-6 sm:p-8 rounded-3xl border border-[#e1e2ed] shadow-xs flex flex-col justify-between space-y-6">
              <div className="space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900">Laporan #0192 Diproses</p>
                      <p className="text-xs text-slate-500 leading-snug mt-0.5">Tim teknis sedang menuju lokasi Jalan Murhum.</p>
                      <p className="text-xs text-slate-400 mt-1.5 font-semibold">2 jam yang lalu</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900">Laporan #0188 Selesai</p>
                      <p className="text-xs text-slate-500 leading-snug mt-0.5">Perbaikan lampu jalan di Pantai Kamali selesai.</p>
                      <p className="text-xs text-slate-400 mt-1.5 font-semibold">Kemarin, 14:20</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900">Laporan Baru Diterima</p>
                      <p className="text-xs text-slate-500 leading-snug mt-0.5">Pengaduan kerusakan drainase Kelurahan Wameo.</p>
                      <p className="text-xs text-slate-400 mt-1.5 font-semibold">2 hari yang lalu</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <Link
                to="/track"
                className="w-full py-3.5 border border-[#e1e2ed] text-[#004ac6] font-bold text-sm rounded-2xl hover:bg-slate-50 transition-colors text-center block"
              >
          ...
          <div className="bg-white rounded-3xl border border-[#e1e2ed] shadow-xs overflow-hidden">
            <div className="p-6 sm:p-8 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500">Daftar riwayat pengaduan infrastruktur publik yang telah Anda serahkan.</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link
                  to="/submit"
                  className="px-5 py-3 bg-[#004ac6] hover:bg-[#2563eb] text-white text-sm font-bold rounded-full shadow-lg shadow-[#004ac6]/20 transition-all flex items-center space-x-1.5"
                >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead className="bg-[#f8fafc] border-b border-[#e1e2ed] text-slate-500 font-bold uppercase tracking-wider text-xs">
                  <tr>
                  ...
                  {filteredComplaints.length > 0 ? (
                    ...
                    <>
                      <tr className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="p-4 text-slate-600">Kel. Batulo</td>
                        <td className="p-4 text-slate-500">12 Apr 2024</td>
                      ...
                      <tr className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="p-4 text-slate-600">Jl. Murhum</td>
                        <td className="p-4 text-slate-500">08 Apr 2024</td>
                      ...
                      <tr className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="p-4 text-slate-600">Pantai Kamali</td>
                        <td className="p-4 text-slate-500">02 Apr 2024</td>
      ...
      <footer className="bg-[#e1e2ed]/60 border-t border-[#e1e2ed] py-12 px-6 sm:px-12 mt-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-sm text-slate-600">
          
          <div className="space-y-3 md:col-span-2">
            <h4 className="font-headline font-black text-base text-[#004ac6]">SIPIL BAUBAU</h4>
        ...
        <div className="max-w-7xl mx-auto mt-8 pt-6 border-t border-slate-300/60 flex items-center justify-between text-xs text-slate-500">
