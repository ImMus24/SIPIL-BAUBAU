  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-golden/10 rounded-full blur-3xl" />
      ...
      <div className="relative text-center max-w-lg mx-auto animate-fade-in-up">
        ...
        <div className="relative w-56 h-56 mx-auto mb-8">
          <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-primary to-navy opacity-10 rotate-6" />
          <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-primary to-navy opacity-10 -rotate-6" />
          <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-primary to-navy flex items-center justify-center shadow-2xl shadow-primary/25">
            <span className="font-heading font-black text-7xl text-white tracking-tight">404</span>
          </div>
          <div className="absolute -top-3 -right-3 w-14 h-14 rounded-2xl bg-golden flex items-center justify-center shadow-lg animate-float">
            <Compass className="w-7 h-7 text-golden-foreground" aria-hidden="true" />
          </div>
        </div>
